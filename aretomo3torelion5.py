...
=======
    tilt_series_star = os.path.join(output_dir, f"{tomo_prefix}.star")
    etomo_directive  = os.path.join(output_dir, f"{tomo_prefix}.edf")  # Dummy file.
    reconstructed_tomo = os.path.join(aretomo_dir, f"{tomo_prefix}_Vol.mrc")
>>>>>>> parent of 5be2626 (fix absolute paths)
...
=======
    even_mrc_file    = os.path.join(aretomo_dir, f"{tomo_prefix}_EVN.mrc")
    odd_mrc_file     = os.path.join(aretomo_dir, f"{tomo_prefix}_ODD.mrc")
    aligned_mrc_file = os.path.join(aretomo_dir, f"{tomo_prefix}.mrc")
    ctf_mrc_file     = os.path.join(aretomo_dir, f"{tomo_prefix}_CTF.mrc")
>>>>>>> parent of 5be2626 (fix absolute paths)
